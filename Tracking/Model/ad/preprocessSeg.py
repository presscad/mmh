...
#    hRef = 10000.; vRef = .2
    ...
    for path in paths:
        ...
        lHip = skeleton.getJointIndex('hip_l'); rHip = skeleton.getJointIndex('hip_r')
        ...
        lc = yma.getElementContactStates(motion_ori, 'ankle_l', hRef, vRef)
        rc = yma.getElementContactStates(motion_ori, 'ankle_r', hRef, vRef)
...
#            print yba.GaitState.text[states[i]], intervals[i]
        ...
        outputName = root+'.seg'
        outputFile = open(motionDir+outputName, 'wb')
