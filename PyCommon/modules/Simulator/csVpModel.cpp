...
//		SE3 boneT(offset*.5);
		// dcjo
		// set body local coordinates manually
		SE3 boneT;
		if( cfgNode.attr("localT") != object() )
			boneT = SE3(pyVec3_2_Vec3(cfgNode.attr("localT")));
		else
			boneT = SE3(offset*.5);
...
//		SE3 boneR = getSE3FromVectors(defaultBoneV, offset);
		SE3 boneR;
		if( cfgNode.attr("localR") != object() )
			boneR = SE3(pySO3_2_SE3(cfgNode.attr("localR")));
		else
