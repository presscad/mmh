...
# if parent_joint_axis == None: assume 3dof parent joint
...
#    rotV = mathlib.normalize(numpy.cross(M, L))
    ...
    if mm.length(rotV) == 0:
        ...
        print "mmAnalyticIK.py: ik_analytic: length of rotV is 0. check the orientations of results of ik"
    rotb = b - b_;
    rota = a_ - a - rotb;
